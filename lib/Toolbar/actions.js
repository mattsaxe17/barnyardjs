...
export default {
  ...
  button: {
    ...
    clearFormatting() {
      ...
      document.querySelector(`.barnyardjs-editor-toolbar[${this.uniqueHash}] select[data-action="toggleHeader"]`).value = '0';
      document.querySelector(`.barnyardjs-editor-toolbar[${this.uniqueHash}] select[data-action="setFontSize"]`).value = '12px';
    },
