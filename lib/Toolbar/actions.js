...
export default {
  ...
  button: {
    ...
    clearFormatting() {
      document.querySelector(`[${this.uniqueHash}] .text-color .colored i`).style.borderColor = defaultTextColorIndicator;
      document.querySelector(`[${this.uniqueHash}] .background-color .colored i`).style.borderColor = defaultBackgroundColorIndicator;
