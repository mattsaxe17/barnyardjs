...
const defaultTextColorIndicator = '#000000';
const defaultBackgroundColorIndicator = '#000000';
...
export default {
  ...
  button: {
    openTextColor(e) {
      document
        .querySelector(
          `[${this.uniqueHash}] .text-color .barnyardjs-editor-toolbar__color-selector`
        )
    ...
    openBackgroundColor(e) {
      document
        .querySelector(
          `[${this.uniqueHash}] .background-color .barnyardjs-editor-toolbar__color-selector`
        )
        .classList.remove('hidden');
    },
    ...
    codeBlock(e) {
      ...
      document.querySelector(`[${this.uniqueHash}] .barnyardjs-editor`).innerHTML += '<br />';
    },
    ...
    clearFormatting() {
      document.querySelector(`[${this.uniqueHash}] .text-color .colored i`).style.borderColor =
        defaultTextColorIndicator;
      document.querySelector(
        `[${this.uniqueHash}] .background-color .colored i`
      ).style.borderColor = defaultBackgroundColorIndicator;
      ...
      document.querySelector(`[${this.uniqueHash}] select[data-action="setFontSize"]`).value =
        '12px';
    },
